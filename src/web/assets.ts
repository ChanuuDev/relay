...
import js from "./public/app.js" with { type: "text" };
...
export const assets = new Map<string, { body: string; type: string }>([
  ["/icon.svg", { body: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><rect width="32" height="32" rx="8" fill="#315ad5"/><path d="M10 24V8h7a5 5 0 0 1 1 10l5 6h-5l-5-6v6zm3-10h4a1 1 0 0 0 0-2h-4z" fill="white"/></svg>', type: "image/svg+xml" }],
